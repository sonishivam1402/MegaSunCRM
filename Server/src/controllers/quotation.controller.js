...
export const createNewQuotation = async (req, res, next) => {
  try {
    ...
    const result = await pool
      ...
      .input("PackingCharge", sql.Decimal(18, 2), data.packingCharge)
      .input("CourierCharge", sql.Decimal(18, 2), data.courierCharge)
      .input("FreightCharge", sql.Decimal(18, 2), data.freightCharge)
