...
import { createNewUser, createUserType, getAllUsers, getUserById, getUsersForDropdown, getUserType, getUserTypeById, getUserTypeNames, updateImageByUserId, updatePassword, updateUserbyId, updateUserTypeById, userMobileBlurValidation } from "../controllers/user.controller.js";
...
userRouter.get("/usersDropdown", authenticate, checkPermission("ReadAccess","User Management"), getUsersForDropdown);
userRouter.get("/contact", authenticate, checkPermission("ReadAccess","User Management"), userMobileBlurValidation);
