        ...
        <div className="p-3 px-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-[#0000006E] rounded-sm bg-[#00000012] p-3 py-6 text-center h-55">
                <div className="flex flex-col items-center justify-center h-full">
                  {previewImage ? (
                    ...
                    <div className='relative'>
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="absolute -top-2 left-37 text-sm bg-green-900 text-white w-5 h-5 rounded-full cursor-pointer"
                        >
                          x
                        </button>
                      </div>
                    ...
                    <>
                      ...
                      <label
                        htmlFor="imageFile"
                        className="text-sm text-green-800 underline hover:text-green-900 hover:cursor-pointer"
                      >
                        Upload from Device
                      </label>
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-green-800 text-white py-3 px-4 rounded-sm text-md font-medium hover:bg-green-900 hover:cursor-pointer  focus:ring-offset-2"
              >
                Update User
              </button>
            </div>
